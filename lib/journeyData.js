...
export const journey = [
  ...
  },
  {
    ...
    logoUrl: "/assets/journey/experience/enablero-logo.png",
    description:
      "Expanded responsibilities across web and mobile applications using React.js, React Native, TypeScript, and MUI. Developed authentication and role-based access features, contributed to internal component libraries, and integrated APIs for scalable solutions. Collaborated with developers on code reviews, performance improvements, and feature delivery while taking ownership of end-to-end development tasks.",
  },
  {
    type: "education",
